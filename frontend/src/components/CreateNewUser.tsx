...
const CreateNewUser = () => {
  ...
  const validateForm = () => {
    ...
    if (!pass1) newErrors.password1 = t("password is Required");

    if (pass1 !== pass2) {
      newErrors.password2 = t("password and confirm password must be same");
    }
              ...
              <>
                ...
                >
                  ...
                  <PasswordInput
                    ...
                    passwordError={errors["password1"]?.length > 0}
                    passwordErrorMessage={errors["password1"]}
                  />
                </FormControl>
                <FormControl
                  sx={{
                ...
                >
                  ...
                  <PasswordInput
                    ...
                    passwordError={errors["password2"]?.length > 0}
                    passwordErrorMessage={errors["password2"]}
                  />
                </FormControl>
              </>
            );
